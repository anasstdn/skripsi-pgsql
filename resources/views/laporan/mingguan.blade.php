	...
	<div class="form-group row">
		...
		<div class="col-md-4" style="text-align:left;">
			<input type="text" class="js-flatpickr form-control form-control-lg bg-white" id="tanggal1" name="tanggal1" placeholder="" data-date-format="d-m-Y" value="{{date('d-m-Y')}}">
		</div>
	</div>
	...
	<div class="row" style="margin-bottom: 0.2em">
		<div class="col-md-6 text-right">
			...
			<button class="btn btn-outline-success btn-md" id="reset1">Reset</button>
		</div>
	</div>
	<br/>
