								...
								<div class="row justify-content-center py-sm-3 py-md-5">
									<div class="col-sm-10 col-md-8">
										<div class="form-group">
											<label for="block-form1-name">Agama</label>
											<input type="text" class="form-control form-control-alt form-control-sm" id="nama_agama" name="nama_agama">
										</div>
										<br/>
										<div class="form-group">
...
<script type="text/javascript">
	$(function() {
		...
		$("#tambah").click(function(){
			...
			$("#judul").html('Tambah Agama');
            $('#mode').val('add');
            $('#form').prop('action', '{{url('agama/store')}}');
		});
