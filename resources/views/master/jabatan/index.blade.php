								...
								<div class="row justify-content-center py-sm-3 py-md-5">
									<div class="col-sm-10 col-md-8">
										<div class="form-group">
											<label for="block-form1-name">Jabatan</label>
											<input type="text" class="form-control form-control-alt form-control-sm" id="nama_jabatan" name="nama_jabatan">
										</div>
										<br/>
										<div class="form-group">
...
<script type="text/javascript">
	$(function() {
		...
		$("#tambah").click(function(){
            ...
            $('#mode').val('add');
            $('#form').prop('action', '{{url('jabatan/store')}}');
		});
   ...
   function ubah_data(id){
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('#mode').val('edit');
            $('#form').prop('action', '{{url('jabatan/update')}}');
