            ...
            <nav id="sidebar" aria-label="Main Navigation">
                ...
                <div class="content-header bg-white-5">
                    ...
                    <a class="font-w600 text-dual" href="{{url('/')}}">
                        ...
                        &nbsp<img class="rounded" src="{{asset('images/')}}/logo_laravel.png" alt="Header Avatar" style="width: 180px;">&nbsp
                        {{-- <span class="smini-hide">
                         <span class="font-w600" style="font-size: 10pt">Laravel Forecast</span>
                        </span> --}}
                    </a>
                    <!-- END Logo -->
