                ...
                <div class="hero">
                    <div class="hero-inner text-center">
                        <div class="content content-full bg-white overflow-hidden">
                            <div class="py-4">
                                <!-- Error Header -->
                                <h1 class="display-1 text-flat invisible animated bounceIn" data-toggle="appear">403</h1>
                                <h2 class="h3 font-w300 text-muted invisible mb-5 animated fadeInUp" data-toggle="appear">Anda tidak memiliki ijin akses halaman ini..</h2>
                                <!-- END Error Header -->
