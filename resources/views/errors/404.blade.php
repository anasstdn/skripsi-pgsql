                ...
                <div class="hero">
                    <div class="hero-inner text-center">
                        <div class="content content-full bg-white overflow-hidden">
                            <div class="py-4">
                                <!-- Error Header -->
                                <h1 class="display-1 text-city invisible animated flipInX" data-toggle="appear">404</h1>
                                <h2 class="h3 font-w300 text-muted invisible mb-5 animated fadeInUp" data-toggle="appear">Halaman tidak ditemukan..</h2>
                                <!-- END Error Header -->
